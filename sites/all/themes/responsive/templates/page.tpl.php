        ...
        <?php if ($site_slogan): ?>
          <div class="site-slogan">
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
              <?php print $site_slogan; ?></a></div><!--site slogan--><?php endif; ?>
      </div>
    </hgroup>
...
<div class="container" id="content-contain">
  ...
  <?php if ($is_front): ?>
    <div class="container">
      <?php if (theme_get_setting('slideshow_display', 'responsive')): ?>
        <!-- Slides -->
        <?php
        $url1 = check_plain(theme_get_setting('slide1_url', 'responsive'));
        $cap1 = check_markup(theme_get_setting('slide1_desc', 'responsive'), 'full_html');
        $url2 = check_plain(theme_get_setting('slide2_url', 'responsive'));
        $cap2 = check_markup(theme_get_setting('slide2_desc', 'responsive'), 'full_html');
        $url3 = check_plain(theme_get_setting('slide3_url', 'responsive'));
        $cap3 = check_markup(theme_get_setting('slide3_desc', 'responsive'), 'full_html');
        ?>
  ...
  <div id="content" class="<?php print $contentwid; ?> columns">
    <div id="breadcrumbs"><?php if (theme_get_setting('breadcrumbs', 'responsive')): ?><?php
...
<?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third'] || $page['footer_fourth']): ?> 
  <div id="bottom" class="container">
    <?php
    $botomwid = "four";
    $bottom = ((bool) $page['footer_first'] + (bool) $page['footer_second'] + (bool) $page['footer_third'] + (bool) $page['footer_fourth']);
    switch ($bottom) {
      case 1: $botomwid = "sixteen";
        break;
      case 2: $botomwid = "eight";
        break;
      case 3: $botomwid = "five";
        break;
      case 4: $botomwid = "four";
    }
    ?>
